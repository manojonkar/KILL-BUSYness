    ...
    <>
      ...
      <main>
        <div className="section-head" style={{ marginTop: 20 }}>
          ...
          <p>Answer honestly - this is completely confidential and only feeds into your organization&apos;s aggregate report.</p>
          <div style={{ display: "inline-block", marginTop: 12, padding: "6px 14px", background: "#ecfdf5", color: "#047857", borderRadius: 20, fontSize: "0.85rem", fontWeight: 700, border: "1px solid #10b981" }}>
            ✓ Confidential
          </div>
        </div>
